...
const projects = [
  ...
  {
    name: "Projet E-commerce React + Bagisto API",
    description:
      "Une boutique en ligne moderne et performante utilisant React pour le frontend, connectée à l'API headless Bagisto (Laravel) pour la gestion du catalogue, du panier et des commandes.",
    tags: [
      {
        name: "React",
        color: "blue-text-gradient",
